...
#2021
barst2021 = bardiag(df[1:28,], ax = df$state_ut[1:28], ay = df$cases_reg2021[1:28], "blue3", 
...
#2020
barst2020 = bardiag(df[1:28,], ax = df$state_ut[1:28], ay = df$cases_reg2020[1:28], "blue3", 
...
uttrend = ggplot(data = uts, aes(x = ut, group = 1))+geom_line(aes(y = y2017), color = "black")+
  ...
  geom_line(aes(y = y2021), color = "purple")+theme_minimal()+theme(axis.text.x = element_text(angle = 90, size = 8))+
